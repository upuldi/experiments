 ...
 */
public class EODTradingSummeryServlet extends HttpServlet {

    private static Logger log = Logger.getLogger(EODTradingSummeryServlet.class);
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            eodTradingSummery.processEODTradingSummery();
            out.write("Success.....");
