      ...
      <div class="footer-content">
        ...
        <div class="footer-box">
            ...
            <ul>
              ...
              <li><a href="footer.jsp#">Lorem ipsum dolor sit amet.</a></li>

              <li><a href="footer.jsp#">Quisque consequat nunc a felis.</a></li>

              <li><a href="footer.jsp#">Suspendisse consequat magna at.</a></li>

              <li><a href="footer.jsp#">Etiam eget diam id ligula rhon.</a></li>

              <li><a href="footer.jsp#">Sed in mauris non nibh.</a></li>
        ...
        <div class="footer-box end-footer-box">
            ...
            <form action="footer.jsp#" method="get">
