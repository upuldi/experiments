...
<div id="content">
    <div class="box">
        <h2>EOD Line Charts Gray</h2>
        <p><p><h1></h1><br></br>

        <fieldset>

            <legend>Stock Data</legend>
            <s:form action="submitDataGrayEODChartSideBarAction.action">
