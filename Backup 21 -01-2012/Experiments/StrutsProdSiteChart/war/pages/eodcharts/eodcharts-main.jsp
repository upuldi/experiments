    ...
    <div class="box">
        ...
        <s:if test="showChart == true ">
            ...
            <fieldset>
                ...
                <h3 align="CENTER">Change of issued quantity.<s:property value="stockCode" /></h3>
                <p> </p>
                <p> </p>
                <p> </p>
                <p> </p>
                ...
                <div id="flashcontent-issued" align="CENTER">
                    <strong>You need to upgrade your Flash Player</strong>
                </div>
                ...
                <h3 align="CENTER">Change of foreign holdings change</h3>
                <p> </p>
                <p> </p>
                <p> </p>
                <p> </p>
